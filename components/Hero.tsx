...
function Hero() {
  ...
  return (
    <section className="flex flex-col items-center p-2 py-10 lg:py-12 gap-10 lg:gap-10 bg-amber-50 dark:bg-neutral-900 dark:text-gray-200">
      ...
      <p className="text-center text-lg dark:text-gray-400 text-gray-800 lg:w-[35%]">
